                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 32) {
                        ...
                        sidebarSection(title: "EXPLORE") {
                            ...
                            SidebarItem(title: "Library", icon: "books.vertical.fill", isSelected: selectedTab == "library", isCompact: isSidebarCollapsed) { selectedTab = "library" }
                            SidebarItem(title: "Vault", icon: "lock.shield.fill", isSelected: false, isCompact: isSidebarCollapsed) { 
                                if let url = URL(string: "http://localhost:8338") {
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 32) {
                        ...
                        case "library": LibraryView().transition(.opacity.combined(with: .scale(scale: 0.95)))
